 ...
 * Group based policies are great for one off requirements. Most issues holes exist because groups are poorly maintain and base policies should be focus'd on all users.
 * 
